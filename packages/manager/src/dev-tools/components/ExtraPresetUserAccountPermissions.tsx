...
import { setCustomUserAccountPermissionsData } from 'src/mocks/presets/extra/userPermissions/userAccountPermissions';
...
export const ExtraPresetUserAccountPermissions = ({
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    try {
      ...
      console.log('Updated newFormData:', newFormData);
      ...
      console.error('Failed to parse JSON from input value:', value);
      console.error(err);
    }
  };
